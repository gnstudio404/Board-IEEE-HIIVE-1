...
const translations = {
  en: {
    ...
    'admin.sessionTime': 'Session Time',
    'admin.details': 'Details',
    'admin.filterByDate': 'Filter by date',
    'admin.clear': 'Clear',
    'admin.downloadPDF': 'Download PDF Report',
    'admin.attendanceRate': 'Attendance Rate',
    'admin.avgWatchTime': 'Avg. Watch Time',
    'admin.watchTime': 'Watch Time',
    'admin.distribution': 'Attendance Distribution',
    'admin.watchTimeDist': 'Watch Time Distribution (mins)',
    'admin.detailedLog': 'Detailed Attendance Log',
    'admin.backToSessions': 'Back to Sessions',
    'admin.minutes': 'min',
    ...
    'register.department': 'Department / Position',
  ...
  ar: {
    ...
    'admin.sessionTime': 'وقت الجلسة',
    'admin.details': 'التفاصيل',
    'admin.filterByDate': 'تصفية حسب التاريخ',
    'admin.clear': 'مسح',
    'admin.downloadPDF': 'تحميل تقرير PDF',
    'admin.attendanceRate': 'نسبة الحضور',
    'admin.avgWatchTime': 'متوسط وقت المشاهدة',
    'admin.watchTime': 'وقت المشاهدة',
    'admin.distribution': 'توزيع الحضور والغياب',
    'admin.watchTimeDist': 'توزيع وقت المشاهدة (بالدقائق)',
    'admin.detailedLog': 'سجل الحضور التفصيلي',
    'admin.backToSessions': 'العودة للجلسات',
    'admin.minutes': 'دقيقة',
    'admin.present': 'حاضر',
    'admin.absent': 'غائب',
    ...
    'register.department': 'القسم / المسمى الوظيفي',
